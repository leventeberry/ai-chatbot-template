...
function setStyle(
  ...
  const cur = elementStyle[styleKey];
  elementStyle[styleKey] = value;

  return () => {
    elementStyle[styleKey] = cur;
  };
}
...
function scrollIntoView(target: Element) {
  ...
  while (currentTarget && currentTarget !== root) {
    ...
    const scrollable = getScrollParent(currentTarget);
    if (
      scrollable !== document.documentElement &&
      scrollable !== document.body &&
      ...
      const targetBottom = currentTarget.getBoundingClientRect().bottom;
